...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // ייבוא היכולות של jQuery על-מנת שה- class AlbumForm יוכל להשתמש בהן
...
var AlbumForm = function () {
    ...
    function AlbumForm(dataService) {
    ...
    _createClass(AlbumForm, [{
        ...
        value: function setSuccessMessage() {
        ...
        value: function addSong(e) {
            ...
            var html = _Templates2.default.songItem();
...
},{"./DataService":6,"./Templates":8,"jquery":1}],3:[function(require,module,exports){
'use strict';
...
var _AlbumTemplate = require('./Templates/AlbumTemplate');

var _AlbumTemplate2 = _interopRequireDefault(_AlbumTemplate);
...
var AlbumPlayer = {
    ...
    fetchAlbum: function fetchAlbum() {
        ...
        _DataService2.default.getAlbumById(1).then(function (album) {
            ...
            var html = _AlbumTemplate2.default.getTemplate(album);
        });
    },
...
},{"./DataService":6,"./Templates/AlbumTemplate":9,"jquery":1}],4:[function(require,module,exports){
'use strict';
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // ייבוא היכולות של jQuery על-מנת שה- class AlbumsBoard יוכל להשתמש בהן
...
var _AlbumPlayer = require('./AlbumPlayer');

var _AlbumPlayer2 = _interopRequireDefault(_AlbumPlayer);
...
var AlbumsBoard = function () {
    ...
    function AlbumsBoard() {
        _classCallCheck(this, AlbumsBoard);
    ...
    _createClass(AlbumsBoard, [{
        ...
        key: 'appendAlbums',
        value: function appendAlbums(albums) {
        ...
        value: function displayAlbum(e) {
            ...
            _DataService2.default.getAlbumById(album_id).then(this.player.playAlbum);
        }
...
},{"./AlbumPlayer":3,"./DataService":6,"./Templates":8,"jquery":1}],5:[function(require,module,exports){
'use strict';
...
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } } // ייבוא היכולות של jQuery על-מנת שה- class App יוכל להשתמש בהן
...
},{"./AlbumForm":2,"./AlbumPlayer":3,"./AlbumsBoard":4,"./Search":7,"jquery":1}],6:[function(require,module,exports){
'use strict';
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // ייבוא היכולות של jQuery על-מנת שה- class DataService יוכל להשתמש בהן
...
var DataService = function () {
    ...
    _createClass(DataService, null, [{
        ...
        key: 'getAlbumById',
        value: function getAlbumById(album_id) {
        ...
        key: 'updateAlbum',
        value: function updateAlbum(album_id) {
            return _jquery2.default.ajax({
        ...
        key: 'deleteAlbum',
        value: function deleteAlbum(album_id) {
            return _jquery2.default.ajax({
                url: 'http://localhost:3000/api/albums/' + album_id,
                contentType: 'application/json',
                method: 'DELETE'
        ...
        key: 'searchAlbum',
        value: function searchAlbum(term) {
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // ייבוא היכולות של jQuery על-מנת שה- class Search יוכל להשתמש בהן
...
var Search = function () {
    ...
    _createClass(Search, [{
        ...
        value: function displayResults(results) {
            ...
            var html = _Templates2.default.searchResults(results);
            ...
            (0, _jquery2.default)('#results-list').html(html);
        }
        ...
        value: function searchAlbum(e) {
            ...
            if (term.length >= 3)
                ...
                _DataService2.default.searchAlbum(term).then(_jquery2.default.proxy(this.displayResults, this));
        ...
        value: function bindEvents() {
            ...
            (0, _jquery2.default)('#search').on('keyup', _jquery2.default.proxy(this.searchAlbum, this));
        }
    }]);
...
},{"./DataService":6,"./Templates":8,"jquery":1}],8:[function(require,module,exports){
'use strict';
...
var Templates = function () {
    ...
    _createClass(Templates, null, [{
        ...
        key: 'searchResults',
        value: function searchResults(results) {
...
var AlbumTemplate = {
    ...
    getTemplate: function getTemplate(album) {
        ...
        var genres = this.albumGenres(album.genres);
    }
