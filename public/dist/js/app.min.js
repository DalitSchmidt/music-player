...
},{"./DataService":5,"./Templates":8,"jquery":1}],3:[function(require,module,exports){
'use strict';
...
},{"./DataService":5,"./Player":6,"./Templates":8,"jquery":1}],4:[function(require,module,exports){
'use strict';
...
},{"./AlbumForm":2,"./AlbumsBoard":3,"./Player":6,"./Search":7,"jquery":1}],5:[function(require,module,exports){
'use strict';
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // ייבוא היכולות של jQuery על-מנת שה- class Player יוכל להשתמש בהן
...
},{"./DataService":5,"./Templates":8,"jquery":1}],8:[function(require,module,exports){
'use strict';
