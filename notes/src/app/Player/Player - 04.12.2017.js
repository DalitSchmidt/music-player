...
const Player = {
    ...
    togglePlaying: function() {
        // המשתנה currentPlayerState מכיל את המצב הנוכחי שמצוי בו הנגן באמצעות הפעלה של הפונקציה getPlayerState שמחזירה את המצב שמצוי בו הנגן על-ידי המשתנה youtubeplayer
        const currentPlayerState = youtubeplayer.getPlayerState()
        // הצגת המשתנה currentPlayerState בחלון ה- console
        console.log(currentPlayerState)
        // נבצע בדיקה בה נבדוק מהו המצב הנוכחי בו מצוי המשתנה currentPlayerState שמכיל את המצב הנוכחי שמצוי בו הנגן באמצעות הפעלה של הפונקציה getPlayerState שמחזירה את המצב שמצוי בו הנגן על-ידי המשתנה youtubeplayer
