...
const Player = {
    ...
    setSong: function( el ) {
        ...
        // המשתנה album_artist מכיל את שם האמן של האלבום באמצעות מציאת האלמנט שיש לו מזהה ייחודי בשם album-info-menu ושיש לו את ה- attribute מסוג data בשם name, כך שלמעשה המשתנה album_artist מכיל את שם האמן
        ...
        // החלפת הטקסט המצוי באלמנט title לטקסט המצוי במשתנה song_name, כך שלמעשה האלמנט title מציג בשם הכרטיסייה את הטקסט 'Now Playing - ' עם שם השיר שמתנגן כעת בנגן
    ...
    changeVolume: function ( e ) {
        ...
        // המשתנה $volume מכיל את האלמנט i שמצוי בתוך האלמנט a שיש לו class מזהה ייחודי בשם volume-up
        ...
        if ( volume == 0 ) {
            // אז המשתנה $volume מוסיף את ה- attribute מסוג class בשם 'fa fa-volume-off'
            $volume.attr('class', "fa fa-volume-off")
        }
        // אחרת, נבדוק אם הערך של המשתנה volume הוא קטן או שווה ל- 50
        else if ( volume <= 50 ) {
            // אז המשתנה $volume מוסיף את ה- attribute מסוג class בשם 'fa fa-volume-down'
            $volume.attr('class', 'fa fa-volume-down')
        }
        // אחרת, נבדוק אם הערך של המשתנה volume הוא גדול מ- 50
        else if ( volume > 50 ) {
            // אז המשתנה $volume מוסיף את ה- attribute מסוג class בשם 'fa fa-volume-up'
    ...
    toggleVolumeBar: function () {
        ...
        // שינוי רוחב האלמנט div שיש לו מזהה ייחודי בשם controls ל- 430px
    ...
    initYoutube: function () {
        // הצהרה על משתנה גלובלי בשם youtubeplayer
        let youtubeplayer
