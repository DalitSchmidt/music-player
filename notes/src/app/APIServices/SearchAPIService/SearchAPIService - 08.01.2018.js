...
const SearchAPIService = {
    ...
    // באמצעות הפונקציה searchGenres המקבלת את המשתנה term אנו מבצעים בקשת get לנתיב 'http://localhost:3000/api/genres/suggestions/' + term, ובכך מתאפשר למעשה לקבל את ההצעות האפשריות לתוצאות החיפוש ממסד הנתונים הקשורים לז'אנרים של האלבום
