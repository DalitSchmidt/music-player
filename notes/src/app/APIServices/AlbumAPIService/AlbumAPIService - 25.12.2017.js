...
const AlbumAPIService = {
    ...
    // באמצעות הפונקציה getGenres אנו מבצעים בקשת get לנתיב 'http://localhost:3000/api/genres', ובכך מתאפשר למעשה לקבל את כל הז'אנרים המצויים במסד הנתונים
    getGenres: function() {
        return $.getJSON('http://localhost:3000/api/genres')
    },

    // באמצעות הפונקציה searchYoutubeID המקבלת את המשתנה youtube_id אנו מבצעים בקשה get לנתיב 'http://localhost:3000/api/youtube/' + youtube_id, ובכך מתאפשר למעשה לבצע חיפוש ולקבל את המזהה הייחודי של סרטון ה- YouTube
