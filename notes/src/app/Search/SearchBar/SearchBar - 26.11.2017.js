...
const SearchBar = {
    ...
    clearResults: function() {
        ...
        $('#results-list').hide(300, function() {
            ...
            $('#search-term').val('')
            // מחיקת ה- class בשם has-suggestion מה- class בשם pull-right
    ...
    bindEvents: function() {
        // כאשר מתבצעת לחיצה על האלמנט button שיש לו מזהה ייחודי בשם search, ומאחר ואנו רוצים שההקשר של this בתוך פונקציית ה- callback בשם searchAlbum יתייחס לאלמנט עצמו (במקרה זה כפתור החיפוש), לכן נשתמש ב- proxy כדי שההקשר של this בתוך הפונקציה searchAlbum יתייחס בכל מקרה לאובייקט searchBar
