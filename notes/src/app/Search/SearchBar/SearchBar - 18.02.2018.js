...
const SearchBar = {
    ...
    clearResults: function () {
        // הסתרת הנתונים המצויים באלמנט div שיש לו מזהה ייחודי בשם results-list לאחר 5 מאיות השנייה כשפונקציית ה- callback שלה מבצעת מספר פעולות שונות
        $('#results-list').hide(500, function () {
