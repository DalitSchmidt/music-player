...
const Search = {
    ...
    searchAlbum: function() {
        ...
        // הפעלה של הפונקציה searchAlbums המקבלת את המשתנה term (המכיל את הטקסט שהוזן בתיבת החיפוש) ושמצוי תחת האובייקט SearchAPIService המאפשרת לבצע חיפוש של נתונים באמצעות ביצוע בקשת get לנתיב 'http://localhost:3000/api/albums/search' + term, כאשר לאחר הפעלת הפונקציה נפעיל promise של התוצאות המתקבלות, על הסטטוס קוד שנקבל ועל xhr באמצעות הפעלה של הפונקציה displayResults המקבלת את המשתנים term, results ו- xhr שבאמצעותה מתאפשר להציג ב- DOM את תוצאות החיפוש
