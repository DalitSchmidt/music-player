...
// ייבוא היכולות של האובייקט RemoveAlbum על-מנת שהאובייקט Application יוכל להשתמש בהן
import RemoveAlbum from './Album/RemoveAlbum'
...
// הגדרת האובייקט Application כקבוע
const Application = {
    ...
    init: function () {
        ...
        SearchBar.init()
        // הפעלה של הפונקציה init המצויה תחת האובייקט RemoveAlbum ושמכילה את כל הפעולות שאנו מעוניינים שיבוצעו עם הפעלתו של האובייקט RemoveAlbum
        RemoveAlbum.init()
    }
}

// הגדרה של כל הנתונים שאנו מעוניינים שיעלו עם העלאת הדף והפעלת הפונקציה init המצויה תחת האובייקט Application המכילה את כל הפעולות שאנו מעוניינים שיבוצעו עם הפעלתו של האובייקט
