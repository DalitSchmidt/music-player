...
import AlbumPlayer from './Album/AlbumPlayer'
...
const App = {
    ...
    init: function() {
        // הפעלה של הפונקציה when (המאפשרת לבצע ניתוב בין הדפים) שמצויה תחת האובייקט Router ומפעילה אובייקט שיש בו פרופרטיס שונים
        Router.when({
        ...
        // שרשור והפעלה של הפונקציה when (המאפשרת לבצע ניתוב בין הדפים) המפעילה אובייקט שיש בו פרופרטיס שונים
            ...
            callback: AlbumPlayer.init.bind( AlbumPlayer )
