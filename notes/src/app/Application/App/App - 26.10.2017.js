...
// ייבוא היכולות של ה- class SearchBar על-מנת שהאובייקט App יוכל להשתמש בהן
...
const App = {
    ...
    init: function() {
        ...
        Router.setupRoutes({
            ...
            // הפרופרטי 'search' מפעיל את הפונקציה init המצויה תחת האובייקט Search וקשירת כל הפעולות המבוצעות באובייקט Search
