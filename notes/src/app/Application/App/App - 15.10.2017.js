...
const App = {
    ...
    init: function() {
        // הפעלה של הפונקציה init המצויה תחת האובייקט Router המכילה את כל הפעולות שאנו מעוניינים שיבוצעו עם הפעלתו של האובייקט
        Router.init()

        // הפעלה של הפונקציה setTimeOut המאפשרת לשלוט על הזמן שבו יטענו הנתונים שבתוך הפונקציה
        setTimeout(() => {
