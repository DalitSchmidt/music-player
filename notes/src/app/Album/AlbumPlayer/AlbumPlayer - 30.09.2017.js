...
const AlbumPlayer = {
    ...
    playSong: function ( e ) {
        ...
        let el = $( e.target )
        // מחיקת ה- class בשם playing מהתגית li המכילה את ה- class בשם playing ושמצויה תחת תגית ol המכיל מזהה ייחודי בשם current-playlist
        ...
        // פנייה ל- attribute מסוג src של תגית iframe שמצויה תחת div המכיל מזהה ייחודי בשם album-cover שבו נחליף בקישור את המזהה הייחודי של כל קליפ בנגן
