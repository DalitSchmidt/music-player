...
import $ from 'jquery'
// ייבוא היכולות של האובייקט DataService על-מנת שהאובייקט AlbumForm יוכל להשתמש בהן
...
const AlbumForm = {
    ...
    saveAlbum: function( e ) {
        ...
        album.songs = songs
        // הפעלה של הפונקציה saveAlbum המקבלת את המשתנה abum ומצויה תחת האובייקט DataService שבאמצעותה מתאפשר לשמור אלבום במסד הנתונים, ולאחר מכן נפעיל promise המפעיל את הפונקציה setSuccessMessage המציגה הודעת הצלחה עם יצירת האלבום
