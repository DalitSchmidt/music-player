...
const AlbumForm = {
    ...
    resetFields: function ( e ) {
        ...
        // נעבור באמצעות לולאת each העוברת איבר-איבר על הנתונים המצויים באלמנטים מסוג input ו- textarea בהתאם למיקום של ה- index וה- input במערך ונפעיל פונקציית callback (המסומנת כפונקציית חץ) שמבצעת מספר פעולות
    ...
    bindEvents: function () {
        ...
        // כאשר מתבצעת הקלדה באלמנט input שיש לו את ה- attribute מסוג name בשם song_youtube המצוי בתוך אלמנט div שיש לו מזהה ייחודי בשם add-album-playlist-form, נפעיל את הפונקציה emptyValues המאפשרת לרוקן מערכים במידת הצורך את האלמנט span כאשר אין נתונים באלמנט input שה- attribute מסוג name שלו הוא song_youtube, כלומר שאין נתונים באלמנט input של המזהה הייחודי של YouTube, ומאחר ואנו רוצים שההקשר של this בתוך פונקציית ה- callback בשם emptyValues יתייחס לאלמנט עצמו (במקרה זה לאלמנט input שיש לו attribue מסוג name בשם song_youtube) נשתמש ב- proxy, כדי שההקשר של this בתוך הפונקציה emptyValues יתייחס בכל מקרה לאובייקט AlbumForm
