...
// ייבוא היכולות של האובייקט SearchResultsTemplates על-מנת שהאובייקט AlbumForm יוכל להשתמש בהן
...
const AlbumForm = {
    ...
    resetFields: function () {
        ...
        // הסרת האלמנט שיש לו class בשם error-message מהאלמנט div שיש לו מזהה ייחודי בשם add-new-album-form ו/או מהאלמנט div שיש לו מזהה ייחודי בשם add-album-playlist-form
            ...
            ( error ) => {
                ...
                switch ( input_name ) {
                    ...
                    case 'song_youtube':
                        ...
                        // הצגת המשתנה youtube_code בחלון ה- console
