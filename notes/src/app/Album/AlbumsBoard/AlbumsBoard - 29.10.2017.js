...
import $ from 'jquery'
// ייבוא היכולות של האובייקט DataService על-מנת שהאובייקט AlbumsBoard יוכל להשתמש בהן
...
const AlbumsBoard = {
    ...
    getAllAlbums: function() {
        // הפונקציה מחזירה את הפונקציה getAllAlbums המצויה תחת האובייקט DataService ושבאמצעותה מתאפשר לקבל את כל האלבומים על-ידי ביצוע בקשת get לנתיב 'http://localhost:3000/api/albums'
