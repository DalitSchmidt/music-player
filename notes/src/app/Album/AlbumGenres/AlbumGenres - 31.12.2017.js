...
const AlbumGenres = {
    ...
    // באמצעות הפונקציה addGenreTag המקבלת את המשתנה tagName מתאפשר להוסיף תג עם שם הז'אנר של האלבום ל- DOM
    addGenreTag: function ( tagName ) {
        // המשתנה html מכיל את התבנית html המכילה את האלמנטים המאפשרים להציג ב- DOM את הז'אנרים של האלבום באמצעות הפעלה של הפונקציה GenreTag המקבלת את המשתנה tagName ומצויה תחת האובייקט AlbumFormTemplates שבאמצעותה אנו יוצרים תבנית html המציגה ב- DOM את הז'אנרים של האלבום
