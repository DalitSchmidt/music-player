...
// ייבוא היכולות של האובייקט DeleteAlbum על-מנת שהאובייקט EditAlbum יוכל להשתמש בהן
import DeleteAlbum from './DeleteAlbum'
// ייבוא היכולות של האובייקט AlbumTemplates על-מנת שהאובייקט EditAlbum יוכל להשתמש בהן
