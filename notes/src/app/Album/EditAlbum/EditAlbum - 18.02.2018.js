    ...
    confirmRemoveSong: function ( e ) {
        ...
        // AlbumAPIService.deleteAlbum( song_id ).then(album => {
            ...
            $('.modal-dialog').fadeOut('slow', () => {
                // המשתנה html מפעיל את הפונקציה removeSuccessDialog המקבלת את המשתנה song_id המכיל את האלמנט הקרוב ביותר עם המספר id של השיר, שמצויה תחת האובייקט EditAlbumTemplates ושבאמצעותה אנו יוצרים תבנית html המציגה ב- DOM הודעה המאשרת שהשיר נמחק
