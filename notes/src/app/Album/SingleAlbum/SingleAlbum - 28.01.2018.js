...
const SingleAlbum = {
    ...
    setAlbumControls: function () {
        ...
        $('#controls').html( html )
        // הסרת האלמנט i הישיר שיש לו class בשם fa-volume-up המצוי בתוך האלמנט div שיש לו מזהה ייחודי בשם controls מה- DOM
        $('#controls').find('>i.fa-volume-up').remove()
        // הסרת ה- class בשם fa-volume-up מהאלמנט i הישיר המצוי בתוך האלמנט div שיש לו מזהה ייחודי בשם volume-controls
