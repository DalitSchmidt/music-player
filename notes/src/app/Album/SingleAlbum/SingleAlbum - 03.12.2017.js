...
// ייבוא היכולות של האובייקט Player על-מנת שהאובייקט AlbumPlayer יוכל להשתמש בהן
...
const AlbumPlayer = {
    ...
    // באמצעות הפונקציה setControls מתאפשר להציג ב- DOM את המקשים השולטים על ההפעלה של הנגן
    ...
    getAlbum: function () {
        ...
        AlbumAPIService.getAlbumById( id ).then(album => {
            ...
            // הפעלה של הפונקציה setControls המאפשרת להציג ב- DOM את המקשים השולטים על ההפעלה של הנגן
            this.setControls()
