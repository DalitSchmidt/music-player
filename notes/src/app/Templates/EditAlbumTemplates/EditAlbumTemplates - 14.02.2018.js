...
const EditAlbumTemplates = {
        ...
        return `
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4 class="text-justify">Are you sure you want to delete ${songName} by ${albumArtist}?</h4>
                </div>
    ...
    // באמצעות הפונקציה deleteSuccessDialog המקבלת את המשתנים currentPage ו- albumId, אנו יוצרים תבנית html המציגה ב- DOM הודעה המאשרת שהשיר נמחק
