        ...
        return `
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="cancel-button" class="pull-left" data-dismiss="modal">Cancel</button>
    ...
    deleteSuccessDialog: function () {
        ...
        return `
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="close-button" class="pull-right" data-dismiss="modal">Close</button>
                </div>
            </div>
        `
    }
