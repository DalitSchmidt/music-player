...
const SingleAlbumTemplates = {
    ...
    // באמצעות הפונקציה albumInfoControls המקבלת את המשתנה albumId אנו יוצרים תבנית html המציגה ב- DOM את המקשים השולטים על המידע של האלבום
    ...
    // באמצעות הפונקציה albumImage המקבלת את המשתנה albumImage המכיל את הפרטים של תמונת האלבום, אנו יוצרים תבנית html המציגה ב- DOM את התמונת cover של האלבום
