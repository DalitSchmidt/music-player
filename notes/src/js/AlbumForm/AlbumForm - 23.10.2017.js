...
import $ from 'jquery'
// ייבוא היכולות של ה- class DataService על-מנת שהאובייקט AlbumForm יוכל להשתמש בהן
import DataService from './DataService'
// ייבוא היכולות של האובייקט Player על-מנת שהאובייקט AlbumForm יוכל להשתמש בהן
import Player from './Player'
// ייבוא היכולות של ה- class Templates על-מנת שהאובייקט AlbumForm יוכל להשתמש בהן
...
const AlbumForm = {
    ...
    addSong: function( e ) {
        ...
        // הכנסת המשתנה html (המכיל את הפוקנציה songItem המצויה תחת ה- class Templates ומפעיל אותה) לתוך התגית div המצויה ב- DOM שיש לה מזהה ייחודי בשם add-album-playlist-form, ובכך אנו מאפשרים למשתמש להוסיף שירים לאלבום במידת הצורך
    ...
    init: function() {
        ...
        // הפעלה של הפונקציה init המצויה תחת האובייקט Player וקשירת כל הפעולות המבוצעות באובייקט Player
