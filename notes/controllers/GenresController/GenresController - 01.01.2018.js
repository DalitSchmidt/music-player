...
const GenresController = {
    // באמצעות הפונקציה getNewGenres המקבלת את המשתנה genres מתאפשר לבצע בקרה על קבלת ז'אנרים חדשים
    ...
    // באמצעות הפונקציה getExistingGenresIds המקבלת את המשתנה genres מתאפשר לקבל את המספר הייחודי של הז'אנרים הקיימים
